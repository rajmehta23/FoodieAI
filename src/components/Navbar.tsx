...
import { Search, Heart, User, Sun, Moon, LayoutGrid, Mic, MicOff, LogOut, ArrowLeft, Sparkles, Store, ShoppingCart, History, Truck } from 'lucide-react';
        ...
        <div className="flex-1 max-w-md mx-8 hidden md:block">
          ...
          {currentUser && activeOrderStatus && activeOrderStatus !== 'delivered' && (
            <motion.button
              ...
              className="hidden sm:flex items-center gap-2 bg-primary-light text-white text-xs font-bold px-3 py-2 rounded-xl shadow-md shadow-primary-light/30 hover:bg-primary-dark transition-all animate-bounce"
            >
          ...
          {currentUser && (
            <>
              ...
              >
                ...
                {cartCount > 0 && (
                  <span className="absolute -top-1 -right-1 bg-red-500 text-white text-[10px] font-black w-4 h-4 flex items-center justify-center rounded-full shadow-md animate-pulse">
                    {cartCount}
                  </span>
                )}
              </button>
